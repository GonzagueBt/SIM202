...
obstacle = zeros(r,4); % matrice des coordonnées des points des segments valides hors obstacles
i=1;
...
hold on
for i=1:(r)
    plot([obstacle(i,1) obstacle(i,3)],[obstacle(i,2) obstacle(i,4)], 'Color', 'green');
end
